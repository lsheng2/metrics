...
class TestBugTrendScopeProviderViews(BugTrendScopeConfigViewTestSupport, TestCase):
    def test_shouldRenderProviderContextAndReadinessOnScopeConfig(self):
        ...
        self.assertIn('dashboard-edit-form box scope-config-provider-workflow is-provider-green', content)
    ...
    def test_shouldRenderHsdesProviderTemplateOnNewScope(self):
        ...
        self.assertIn('dashboard-edit-form box scope-config-provider-workflow is-provider-blue', content)
    ...
    def test_shouldKeepScopeConfigProviderTabsUsableAcrossDesktopAndPhoneInBrowser(self):
        ...
        self.assertTrue(results['desktop']['workflow_frame_is_blue'])
        self.assertTrue(results['phone']['workflow_frame_is_blue'])
        self.assertTrue(results['desktop']['workflow_frame_wraps_work_area'])
        self.assertTrue(results['phone']['workflow_frame_wraps_work_area'])
