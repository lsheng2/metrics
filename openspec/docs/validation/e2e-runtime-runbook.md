...
7. Record the result in `openspec/docs/validation/c0-validation-closure-evidence.md`.
8. Run:
...
5. Record the result in `openspec/docs/validation/c0-validation-closure-evidence.md`.
...
7. Record the result in `openspec/docs/validation/c1-evidence-link-validation-evidence.md`.
8. Run:
