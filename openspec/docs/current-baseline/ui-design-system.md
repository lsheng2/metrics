...
| Dense dashboard table | `main.css` | `dashboard-dense-table` | Current Tasks, Pull Requests, Task Forecast, velocity task tables, Workbench evidence | Static table-contract audit, visual manifest route coverage, plus browser padding, row-height, button-height, and overflow metrics |
