...
METRICS_SCOPE_BINDING_POLICY = env.str('METRICS_SCOPE_BINDING_POLICY', default='compatibility_allowed')
...
METRICS_AI_BASE_EMBED_MODE = env.str('METRICS_AI_BASE_EMBED_MODE', default='app-chat')
