...
```powershell
curl.exe --noproxy 127.0.0.1 "http://127.0.0.1:8002/api/bug-trend/chart-data/?scope_id=3&begin=2026-06-01&end=2026-08-09"
```
...
```powershell
curl.exe --noproxy 127.0.0.1 -u admin:admin "http://127.0.0.1:3001/api/datasources/proxy/uid/metrics-bug-trend-api/api/bug-trend/chart-data/?scope_id=3&begin=2026-06-01&end=2026-08-09"
```
