...
机器 gate 在 [`scripts/validate_grafana_artifacts.py`](../scripts/validate_grafana_artifacts.py)。允许的 root/shape/API surface 在 [`docs/grafana-approved-data-surfaces.json`](grafana-approved-data-surfaces.json)。
